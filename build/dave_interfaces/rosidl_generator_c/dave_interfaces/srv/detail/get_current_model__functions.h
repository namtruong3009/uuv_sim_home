...
#ifndef DAVE_INTERFACES__SRV__DETAIL__GET_CURRENT_MODEL__FUNCTIONS_H_
#define DAVE_INTERFACES__SRV__DETAIL__GET_CURRENT_MODEL__FUNCTIONS_H_
 ...
 * calls
 * dave_interfaces__srv__GetCurrentModel_Request__init().
...
/**
 * It calls
 * dave_interfaces__srv__GetCurrentModel_Request__fini()
...
/// Check for srv/GetCurrentModel message equality.
/**
...
/// Copy a srv/GetCurrentModel message.
/**
...
/**
 * It calls
 * dave_interfaces__srv__GetCurrentModel_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetCurrentModel message array equality.
/**
...
/// Copy an array of srv/GetCurrentModel messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dave_interfaces__srv__GetCurrentModel_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dave_interfaces
...
/**
 * It calls
 * dave_interfaces__srv__GetCurrentModel_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dave_interfaces
...
/**
 * It calls
 * dave_interfaces__srv__GetCurrentModel_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * dave_interfaces__srv__GetCurrentModel_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_dave_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dave_interfaces__srv__GetCurrentModel_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dave_interfaces
...
/**
 * It calls
 * dave_interfaces__srv__GetCurrentModel_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dave_interfaces
...
/**
 * It allocates the memory for the array and calls
 * dave_interfaces__srv__GetCurrentModel_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dave_interfaces
...
/**
 * It calls
 * dave_interfaces__srv__GetCurrentModel_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DAVE_INTERFACES__SRV__DETAIL__GET_CURRENT_MODEL__FUNCTIONS_H_
