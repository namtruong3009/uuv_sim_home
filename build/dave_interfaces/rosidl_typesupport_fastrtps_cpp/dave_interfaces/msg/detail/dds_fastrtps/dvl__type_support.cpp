...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dave_interfaces::msg::DVL & ros_message)
{
  // Member: header
  ...
  // Member: target
  dave_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: target
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dave_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_DVLTarget(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: beams
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dave_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_DVLBeam(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const dave_interfaces::msg::DVL *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dave_interfaces::msg::DVL *>(
    untyped_ros_message);
...
{
  return &dave_interfaces::msg::typesupport_fastrtps_cpp::_DVL__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dave_interfaces, msg, DVL)() {
  return &dave_interfaces::msg::typesupport_fastrtps_cpp::_DVL__handle;
}
