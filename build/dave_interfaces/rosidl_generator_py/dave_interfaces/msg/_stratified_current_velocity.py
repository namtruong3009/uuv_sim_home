...
class Metaclass_StratifiedCurrentVelocity(type):
    """Metaclass of message 'StratifiedCurrentVelocity'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__stratified_current_velocity
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__stratified_current_velocity
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__stratified_current_velocity
            cls._TYPE_SUPPORT = module.type_support_msg__msg__stratified_current_velocity
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__stratified_current_velocity
...
class StratifiedCurrentVelocity(metaclass=Metaclass_StratifiedCurrentVelocity):
    """Message class 'StratifiedCurrentVelocity'."""
