...
bool dave_interfaces__msg__dvl_target__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dave_interfaces.msg._dvl_target.DVLTarget", full_classname_dest, 41) == 0);
  }
  dave_interfaces__msg__DVLTarget * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of DVLTarget */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dave_interfaces.msg._dvl_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DVLTarget");
