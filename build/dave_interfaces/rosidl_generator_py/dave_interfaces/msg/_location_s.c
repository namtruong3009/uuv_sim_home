...
bool dave_interfaces__msg__location__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dave_interfaces.msg._location.Location", full_classname_dest, 38) == 0);
  }
  dave_interfaces__msg__Location * ros_message = _ros_message;
  {  // transponder_id
...
PyObject * dave_interfaces__msg__location__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dave_interfaces.msg._location");
