...
bool dave_interfaces__msg__stratified_current_velocity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dave_interfaces.msg._stratified_current_velocity.StratifiedCurrentVelocity", full_classname_dest, 74) == 0);
  }
  dave_interfaces__msg__StratifiedCurrentVelocity * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of StratifiedCurrentVelocity */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dave_interfaces.msg._stratified_current_velocity");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "StratifiedCurrentVelocity");
