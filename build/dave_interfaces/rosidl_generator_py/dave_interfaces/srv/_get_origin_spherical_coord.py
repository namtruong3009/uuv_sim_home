...
class Metaclass_GetOriginSphericalCoord_Event(type):
    """Metaclass of message 'GetOriginSphericalCoord_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_origin_spherical_coord__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_origin_spherical_coord__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_origin_spherical_coord__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_origin_spherical_coord__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_origin_spherical_coord__event
...
class GetOriginSphericalCoord_Event(metaclass=Metaclass_GetOriginSphericalCoord_Event):
    """Message class 'GetOriginSphericalCoord_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<dave_interfaces/GetOriginSphericalCoord_Request, 1>',
        'response': 'sequence<dave_interfaces/GetOriginSphericalCoord_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dave_interfaces', 'srv'], 'GetOriginSphericalCoord_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dave_interfaces', 'srv'], 'GetOriginSphericalCoord_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from dave_interfaces.srv import GetOriginSphericalCoord_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetOriginSphericalCoord_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetOriginSphericalCoord_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from dave_interfaces.srv import GetOriginSphericalCoord_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetOriginSphericalCoord_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetOriginSphericalCoord_Response'"
...
class Metaclass_GetOriginSphericalCoord(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dave_interfaces.srv import _get_origin_spherical_coord
            ...
            if _get_origin_spherical_coord.Metaclass_GetOriginSphericalCoord_Event._TYPE_SUPPORT is None:
                _get_origin_spherical_coord.Metaclass_GetOriginSphericalCoord_Event.__import_type_support__()


class GetOriginSphericalCoord(metaclass=Metaclass_GetOriginSphericalCoord):
    from dave_interfaces.srv._get_origin_spherical_coord import GetOriginSphericalCoord_Request as Request
    from dave_interfaces.srv._get_origin_spherical_coord import GetOriginSphericalCoord_Response as Response
    from dave_interfaces.srv._get_origin_spherical_coord import GetOriginSphericalCoord_Event as Event
