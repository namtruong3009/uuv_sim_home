...
ROSIDL_GENERATOR_C_EXPORT
bool dave_interfaces__srv__transform_to_spherical_coord__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dave_interfaces.srv._transform_to_spherical_coord.TransformToSphericalCoord_Event", full_classname_dest, 81) == 0);
  }
  dave_interfaces__srv__TransformToSphericalCoord_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!dave_interfaces__srv__TransformToSphericalCoord_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create dave_interfaces__srv__TransformToSphericalCoord_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    dave_interfaces__srv__TransformToSphericalCoord_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!dave_interfaces__srv__transform_to_spherical_coord__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!dave_interfaces__srv__TransformToSphericalCoord_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create dave_interfaces__srv__TransformToSphericalCoord_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    dave_interfaces__srv__TransformToSphericalCoord_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!dave_interfaces__srv__transform_to_spherical_coord__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of TransformToSphericalCoord_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dave_interfaces.srv._transform_to_spherical_coord");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TransformToSphericalCoord_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = dave_interfaces__srv__transform_to_spherical_coord__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = dave_interfaces__srv__transform_to_spherical_coord__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
