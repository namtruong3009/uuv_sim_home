...
class Metaclass_SetCurrentModel_Event(type):
    """Metaclass of message 'SetCurrentModel_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_current_model__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_current_model__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_current_model__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_current_model__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_current_model__event
...
class SetCurrentModel_Event(metaclass=Metaclass_SetCurrentModel_Event):
    """Message class 'SetCurrentModel_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<dave_interfaces/SetCurrentModel_Request, 1>',
        'response': 'sequence<dave_interfaces/SetCurrentModel_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dave_interfaces', 'srv'], 'SetCurrentModel_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['dave_interfaces', 'srv'], 'SetCurrentModel_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from dave_interfaces.srv import SetCurrentModel_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetCurrentModel_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetCurrentModel_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from dave_interfaces.srv import SetCurrentModel_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetCurrentModel_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetCurrentModel_Response'"
...
class Metaclass_SetCurrentModel(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_current_model.Metaclass_SetCurrentModel_Event._TYPE_SUPPORT is None:
                _set_current_model.Metaclass_SetCurrentModel_Event.__import_type_support__()
...
class SetCurrentModel(metaclass=Metaclass_SetCurrentModel):
    ...
    from dave_interfaces.srv._set_current_model import SetCurrentModel_Event as Event
