  ...
  void * untyped_ros_message)
{
  ...
  _GetCurrentModel_Request__ros_msg_type * ros_message = static_cast<_GetCurrentModel_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _GetCurrentModel_Response__ros_msg_type * ros_message = static_cast<_GetCurrentModel_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: mean
  {
    cdr >> ros_message->mean;
  }
