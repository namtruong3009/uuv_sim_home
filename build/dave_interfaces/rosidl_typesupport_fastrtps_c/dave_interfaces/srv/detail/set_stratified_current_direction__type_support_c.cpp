  ...
  void * untyped_ros_message)
{
  ...
  _SetStratifiedCurrentDirection_Request__ros_msg_type * ros_message = static_cast<_SetStratifiedCurrentDirection_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: layer
  {
    cdr >> ros_message->layer;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _SetStratifiedCurrentDirection_Response__ros_msg_type * ros_message = static_cast<_SetStratifiedCurrentDirection_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
