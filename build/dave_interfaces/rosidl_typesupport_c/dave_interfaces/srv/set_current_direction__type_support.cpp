...
static const _SetCurrentDirection_Event_type_support_symbol_names_t _SetCurrentDirection_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dave_interfaces, srv, SetCurrentDirection_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dave_interfaces, srv, SetCurrentDirection_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dave_interfaces, srv, SetCurrentDirection_Event)() {
  return &::dave_interfaces::srv::rosidl_typesupport_c::SetCurrentDirection_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t SetCurrentDirection_service_type_support_handle = {
  ...
  &SetCurrentDirection_Request_message_type_support_handle,
  &SetCurrentDirection_Response_message_type_support_handle,
  &SetCurrentDirection_Event_message_type_support_handle,
