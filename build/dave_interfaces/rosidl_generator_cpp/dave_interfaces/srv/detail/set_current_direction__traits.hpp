...
inline void to_flow_style_yaml(
  const SetCurrentDirection_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const SetCurrentDirection_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use dave_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const dave_interfaces::srv::SetCurrentDirection_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  dave_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use dave_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const dave_interfaces::srv::SetCurrentDirection_Event & msg)
{
  return dave_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<dave_interfaces::srv::SetCurrentDirection_Event>()
{
  return "dave_interfaces::srv::SetCurrentDirection_Event";
}

template<>
inline const char * name<dave_interfaces::srv::SetCurrentDirection_Event>()
{
  return "dave_interfaces/srv/SetCurrentDirection_Event";
}

template<>
struct has_fixed_size<dave_interfaces::srv::SetCurrentDirection_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<dave_interfaces::srv::SetCurrentDirection_Event>
  : std::integral_constant<bool, has_bounded_size<dave_interfaces::srv::SetCurrentDirection_Request>::value && has_bounded_size<dave_interfaces::srv::SetCurrentDirection_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<dave_interfaces::srv::SetCurrentDirection_Event>
  : std::true_type {};
